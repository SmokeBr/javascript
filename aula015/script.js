...
function adicionar() {
    if(isNumero(num.value) && !inLista(num.value,valores)) {
        ...
        window.alert('Valor invalido ou ja foi adicionado !!! ')
    }
    num.value = ''
    num.focus()
}
...
function finalizar() {
    if (valores.length == 0) {
        window.alert('Adicionei valores antes de finalizar !!! ')
    } else {
        ...
        media = soma / tot
        res.innerHTML = ''
        res.innerHTML += `<p>No total temos ${tot} número cadastrados ... </p>`
